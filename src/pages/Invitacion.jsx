...
import { dataBautizo } from "../../data.js";
        ...
        play && (
          <>
            ...
            <section className="contador centrar">
              <h2 className="datos-tittle">Mi Bautizo</h2>
            ...
            <div className="banner-img">
              <img src={`./img/${img_banner1}.webp`} alt="imagen_2" />
            </div>
            ...
            <section className="regalos">
              ...
              <div className="regalos-mesa">
                ...
                <div className="regalos-mesa-body">
                  <p>Tu cariño es el mejor obsequio, pero si deseas sumar una sonrisa más, un <span>Juguete</span> sería un detalle especial.</p>
